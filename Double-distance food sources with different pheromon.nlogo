globals [ TFood AntsWithFood count-ant source1 source2 ]
...
to setup-food  ;; patch procedure
  ...
  if (distancexy 15 0) < 4
  [ set food-source-number 1 ]
  ;; setup food source two on the lower-left
  if (distancexy -30 0) < 4
...
to recolor-patch  ;; patch procedure
  ...
  [ ifelse food > 0
    [ if food-source-number = 1
      [ set pcolor blue
        set source1  1]
      if food-source-number = 2 [ set pcolor green
          set source2  2]]
...
to go  ;; forever button
  ...
  ask turtles
   ...
   set AntsWithFood AntsWithFood + 1]
...
to return-to-nest  ;; turtle procedure
  ...
  [ if source1 = 1
    ...
    uphill-nest-scent]  ;; drop some chemical
    if source2 = 2
     [set chemical chemical + (2 * 60)
...
"" ""
PENS
"food-in-pile1" 1.0 0 -13345367 true "" "plotxy ticks sum [food] of patches with [pcolor = blue]"
"food-in-pile2" 1.0 0 -2674135 true "" "plotxy ticks sum [food] of patches with [pcolor = green]"
...
94
With Food
count turtles with [color = orange + 1]
17
1
11
...
1343
182
# of Ants with Food Vs without Food
NIL
NIL
0.0
10.0
...
"" ""
PENS
"Ant with Food" 1.0 2 -955883 true "" "plot count turtles with [color = orange + 1]"
"Ant without Food" 1.0 2 -7500403 true "" "plot count turtles with [color = red]"
...
1373
563
Experiment Set up\n\nTwo different food sources (ants diffuse double amount of chemical in the furthest food source) 
11
0.0
1
